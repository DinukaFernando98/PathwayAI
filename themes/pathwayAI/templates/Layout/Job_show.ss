        ...
        <section class="container position-relative text-center">
            <div class="grid">
                <div class="g-start-1 g-col-12    g-start-lg-2  g-col-lg-10  g-start-xxl-3 g-col-xxl-8">
                    ...
                    <h1 class="fs-6 fw-semibold text-green" anim-chars="" text-split="">Hiring now!</h1>
                    <h2 class="h1" anim-chars="" text-split="">$Job.Title</h2>
                    <p anim-chars="" text-split="">$Job.Company.Name</p>
                    <p anim-chars="" text-split=""><em>$Job.Location | $Job.Type</em></p>
