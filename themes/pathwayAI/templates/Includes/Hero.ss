...
<div class="min-vh-100 d-flex justify-content-center flex-column position-relative">
    <div class="video-bg w-100 mask-bottom heroScrubAnimation">
        <video src="/_resources/themes/pathwayAI/vid/home-video.mp4" playsinline="" muted="muted" loop="loop" autoplay="" id="home-video" class="autoplayVideo opacity-25"></video>
    </div>
    ...
    <div class="container py-4 text-center position-relative">
        ...
        <p class="h5 mb-6 pb-xl-4" anim-fade="">Explore top courses, job fairs, university programs, and career opportunitiessss.</p>
